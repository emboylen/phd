...
static int __Pyx_modinit_type_import_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_mstate->__pyx_ptype_5spacy_6lexeme_Lexeme = __Pyx_ImportType_3_2_1(__pyx_t_1, "spacy.lexeme", "Lexeme",
  #if defined(PYPY_VERSION_NUM) && PYPY_VERSION_NUM < 0x050B0000
  sizeof(struct __pyx_obj_5spacy_6lexeme_Lexeme), __PYX_GET_STRUCT_ALIGNMENT_3_2_1(struct __pyx_obj_5spacy_6lexeme_Lexeme),
  #elif CYTHON_COMPILING_IN_LIMITED_API
  sizeof(struct __pyx_obj_5spacy_6lexeme_Lexeme), __PYX_GET_STRUCT_ALIGNMENT_3_2_1(struct __pyx_obj_5spacy_6lexeme_Lexeme),
  #else
  sizeof(struct __pyx_obj_5spacy_6lexeme_Lexeme), __PYX_GET_STRUCT_ALIGNMENT_3_2_1(struct __pyx_obj_5spacy_6lexeme_Lexeme),
  #endif
  __Pyx_ImportType_CheckSize_Warn_3_2_1); if (!__pyx_mstate->__pyx_ptype_5spacy_6lexeme_Lexeme) __PYX_ERR(2, 24, __pyx_L1_error)
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    ...
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (267 bytes) */
