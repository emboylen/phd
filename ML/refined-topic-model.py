...
if __name__ == '__main__':
    ...
    def compute_coherence_values(dictionary, corpus, texts, limit, start=2, step=1):
        ...
        for num_topics in tqdm(topic_range, desc="Training LDA models", unit="model"):
            ...
            tqdm.write(f"  → Training LDA with k={num_topics} topics...")
            ...
            tqdm.write(f"  → Computing coherence score for k={num_topics}...")
            ...
            coherence_model = CoherenceModel(
                ...
                coherence='c_v',
                processes=1  # Disable multiprocessing for Windows compatibility
            )
            ...
            tqdm.write(f"  ✓ k={num_topics} complete. Coherence: {coh_score:.4f}")
            ...
            if coh_score > best_coherence:
                ...
                best_model = model
                best_k = num_topics
                tqdm.write(f"  ★ New best model: k={num_topics} (Coherence: {coh_score:.4f})")
